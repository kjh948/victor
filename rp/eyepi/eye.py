...
class Eye:
    def __init__(self, eyeRadius, posX = 0, posY = 0, flip = False):
        ...
        dom = parse(EXEC_PATH+"/graphics/cyclops-eye.svg")
#        dom = parse("eyepi/graphics/eye.svg")
        ...
        # Load texture maps --------------------------------------------------------
        irisMap   = pi3d.Texture("/home/pi/workspace/victor/rp/eyepi/graphics/iris.jpg"  , mipmap=False, filter=pi3d.GL_LINEAR)
        #irisMap   = pi3d.Texture(EXEC_PATH+"/graphics/iris.jpg"  , mipmap=False, filter=pi3d.GL_LINEAR)
        scleraMap = pi3d.Texture(EXEC_PATH+"/graphics/sclera.png", mipmap=False, filter=pi3d.GL_LINEAR, blend=True)
        lidMap    = pi3d.Texture(EXEC_PATH+"/graphics/lid.png"   , mipmap=False, filter=pi3d.GL_LINEAR, blend=True)
        # U/V map may be useful for debugging texture placement; not normally used
        #uvMap     = pi3d.Texture("eyepi/graphics/uv.png"    , mipmap=False, filter=pi3d.GL_LINEAR, blend=False, m_repeat=True)
