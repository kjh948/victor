...
list = listdir("./eyes/Romibo excited/")
list.sort()
list_for_romibo_excited=["./eyes/Romibo excited/"+ i for i in list]


#Make list of .png files used for animation of indifferent
list = listdir("./eyes/Romibo indifferent/")
list.sort()
list_for_romibo_indifferentShort=["./eyes/Romibo indifferent/"+ i for i in list]

#reversing blinking1
list2 = ["./eyes/Romibo indifferent/"+ i for i in list]
...
list = listdir("./eyes/eyelid blink/")
list.sort()
list_for_romibo_eyelidBlink=["./eyes/eyelid blink/"+ i for i in list]


#reversing blinking2
list2 = ["./eyes/eyelid blink/"+ i for i in list]
list2.sort(reverse=True)
list_for_romibo_eyelidBlink=list_for_romibo_eyelidBlink+ list2

#make a list of files for animation of curious emotion
list = listdir("./eyes/Romibo curious/")
list.sort()
list_for_romibo_curious=["./eyes/Romibo curious/"+ i for i in list]
